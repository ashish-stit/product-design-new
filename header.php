...
<header class="header">
    <div class="container">
        <a href="https://www.kool-kinder.com/" class="logo">
            <img src="" alt="Kool-Kinder">
        </a>
        <div class="menu">
            <a href="#" class="btn_menu"><i class="fa fa-bars" aria-hidden="true"></i></a>
            <ul class="main-menu">
                <li><a href="<?php echo $lumise->cfg->url.'mydesign.php'; ?>"><?php echo $lumise->lang('My Design'); ?></a></li>
                <li><a href="<?php echo $lumise->cfg->url; ?>"><?php echo $lumise->lang('Create Page'); ?></a></li>
                <li><a href="<?php echo $lumise->cfg->url.'cart.php'; ?>"><?php echo $lumise->lang('Create Book'); ?></a></li>
