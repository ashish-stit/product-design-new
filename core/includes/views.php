...
class lumise_views extends lumise_lib {
	...
	<ul data-block="left" data-resp="file">
		...
		<li data-tool="file" data-view="list">
			...
			<ul data-view="sub" id="lumise-file-nav">
				...
				<li data-func="clear">
				 ...
				 -->
				<li data-func="save">
					<span><?php echo $this->main->lang('Save to My Pages'); ?></span><small>(Ctrl+S)</small>
				</li>
				<?php 
		...
		<li data-tool="designs" data-callback="designs">
			<span><?php echo $this->main->lang('Page Designs List'); ?></span>
			<ul data-view="sub">
				<header>
					<h3>
						...
						<?php
							...
							$about->content = '<span data-sub="about">'.
												...
												'<p data-view="powered" class="md">'.
													'Powered by '.
													'<a href="Kool-Kinder.com='.
													urlencode($_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI']).
													'" target="_blank">Kool-Kinder</a> '.
													'version '.LUMISE.
												'</p>'.
											  '</span>';
	...
	<ul data-block="right">
		...
		?>
		 <li id="lumise-proceed">
			<button id="lumise-cart-action" class="lumise-btn-primary" data-add="Save Design" data-update="<?php echo $this->main->lang('Update cart'); ?>" data-action="update-cart">
				<span>Save Design</span> 
				<i class="lumisex-android-arrow-forward"></i>
			</button>
		</li>
		 <li id="lumise-proceed">
			<button id="lumise-cart-action-edit" class="lumise-btn-primary" data-add="Save Design" data-update="<?php echo $this->main->lang('Update cart'); ?>" data-action="update-cart">
		...
		?>
		<li id="back-btn">
			<a href="<?php echo $back_link; ?>" class="back_shop"><?php echo $this->main->lang('Create a Lesson'); ?></a>
		</li>
		<?php } ?>
