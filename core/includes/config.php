...
class lumise_cfg extends lumise_tmpl_register{
    ...
    public $settings = array(
		...
		'logo' => '',
		'favicon' => '',
		'logo_link' => 'http://localhost/product-design',
		'primary_color' => '',
		'conditions' => '',
    ...
    public function init() {
	    ...
	    $this->js_lang = array(
			...
			'172'=> $lumise->lang('Your design saved successfully'),
			...
			'214'=> $lumise->lang('Your file upload is not allowed, please upload video files only'),
	    );
