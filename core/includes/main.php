...
class lumise {
	...
	public function check_upload ($time = '') {
		...
		$args = $this->apply_filters('upload_folders', array('settings', 'cliparts', 'adminimages','templates', 'products', 'thumbnails', 'user_uploads', 'fonts', 'orders', 'designs', 'shares', 'printings', 'logs', 'user_data', 'addons'));
		...
		if ($time !== '') {
			...
			$arym = $this->apply_filters('upload_folders', array('user_uploads', 'cliparts', 'adminimages','templates', 'shares', 'designs', 'user_data', 'orders'));
